...
_sage_const_4 = Integer(4); _sage_const_5 = Integer(5); _sage_const_6 = Integer(6); _sage_const_7 = Integer(7); _sage_const_0 = Integer(0); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_3 = Integer(3)
import csv
...
label_values = [_sage_const_4 , _sage_const_5 , _sage_const_6 , _sage_const_7 ]
nodes = _sage_const_4 
